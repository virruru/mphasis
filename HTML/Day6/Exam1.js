...
function loadStep5Review() {
 ...
 if (document.getElementById('CheckboxC').checked == 1) {

        document.getElementById('ReviewC').innerHTML = 'Yes';

    }

    else {

        document.getElementById('ReviewC').innerHTML = 'No';

    }
 if (document.getElementById('CheckboxPy').checked == 1) {

        document.getElementById('ReviewPy').innerHTML = 'Yes';

    }

    else {

        document.getElementById('ReviewPy').innerHTML = 'No';
